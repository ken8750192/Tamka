...
//            $query->join('LEFT', '#__molajo_configuration AS contentTypeConfig ON contentTypeConfig.option_value = a.content_type AND contentTypeConfig.option_id = '. (int) MOLAJO_CONFIG_OPTION_ID_CONTENT_TYPES .' AND contentTypeConfig.component_option = "'.JRequest::getCmd('option').'"');
