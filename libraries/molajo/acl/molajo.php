...
{	
    ...
    public function getUserQueryParts ($query, $type, $params)
    {
        ...
        $db = JFactory::getDbo();     
        MAccess::insertFilterQuery($db, $query, 'a.asset_id' , 'core.view');
     ...
     */
    public function getFilterQueryParts ($query, $type, $params)
    {
        if (is_array($params)) {
        ...
        $db = JFactory::getDbo();     
        MAccess::insertFilterQuery($db, $query, 'a.asset_id' , 'core.view', null, $filterValue );
